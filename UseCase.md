...
##### Базовый сценарий:
1. Система проверяет, что клиент передал свою геолокацию.<br> ([AC_1](#альтернативные-сценарии))
...
8. Система резервирует выбранное время в БД. ([AC_2, AC_3](#альтернативные-сценарии))
