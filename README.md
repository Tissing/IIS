...
2. Система ищет ближайшие к позиции клиента мойки. ([AL01](https://github.com/Tissing/IIS/blob/main/README.md#al01-%D0%B0%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC-%D0%BF%D0%BE%D0%B8%D1%81%D0%BA%D0%B0-%D0%BC%D0%BE%D0%B5%D0%BA-%D0%BF%D0%BE-%D0%B0%D0%B4%D1%80%D0%B5%D1%81%D1%83-%D0%B8%D0%BB%D0%B8-%D0%B3%D0%B5%D0%BE%D0%BB%D0%BE%D0%BA%D0%B0%D1%86%D0%B8%D0%B8))
3. Формируется список моек.
4. Система отображает "Экран с картой и списком моек". ([UI_01](https://github.com/Tissing/IIS/blob/main/README.md#ui_1-%D1%8D%D0%BA%D1%80%D0%B0%D0%BD-%D1%81-%D0%BA%D0%B0%D1%80%D1%82%D0%BE%D0%B9-%D0%B8-%D1%81%D0%BF%D0%B8%D1%81%D0%BA%D0%BE%D0%BC-%D0%BC%D0%BE%D0%B5%D0%BA))
5. Система ожидает выбора мойки клиентом.
6. Система переходит к [UC4](https://github.com/Tissing/IIS/blob/main/README.md#uc4-%D0%B2%D1%8B%D0%B1%D1%80%D0%B0%D1%82%D1%8C-%D1%83%D1%81%D0%BB%D1%83%D0%B3%D1%83).
7. Сценарий завершен.
...
3. Система отображает экран "Итоговый вариант записи". ([UI_3]())
...
3. Система отображает "Список доступных услуг". ([UI_4]())
4. Система ожидает выбора пользователя.
5. Система переходит к  [UC2]()
6. Сценарий завершен.
...
2. Система отображает "Экран списка активных записей". ([UI_5]())
...
3. Система отображает "Чат технической поддержки". ([UI_6]())
